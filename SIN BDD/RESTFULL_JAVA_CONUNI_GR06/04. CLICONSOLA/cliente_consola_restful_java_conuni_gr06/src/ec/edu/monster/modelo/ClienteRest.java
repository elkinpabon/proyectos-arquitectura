 ...
 * Reemplaza al ClienteSoap del cliente SOAP. Usa HttpURLConnection
...
public class ClienteRest {
    ...
    /**
     * GET con un parametro {@code valor=...} en query string.
     * Devuelve el cuerpo JSON crudo.
     */
    ...
    /**
     * POST con cuerpo JSON. Devuelve el cuerpo de la respuesta.
     */
    ...
    /**
     * Extrae un campo numerico simple de un JSON plano.
     * Busca "campo":valor donde valor es un numero (puede tener signo y decimales).
     */
    ...
    /**
     * Extrae un campo booleano simple de un JSON plano.
     */
