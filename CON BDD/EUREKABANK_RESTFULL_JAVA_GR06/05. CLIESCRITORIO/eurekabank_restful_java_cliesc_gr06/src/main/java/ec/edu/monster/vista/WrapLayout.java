...
/**
 * FlowLayout que SÍ reporta su alto real cuando los componentes se envuelven
 * en varias líneas (FlowLayout normal solo reporta 1 línea y se cortan los
 * botones). Basado en la implementación pública de Rob Camick.
 */
